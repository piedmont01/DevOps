...
dir_name = os.getcwd()
host_fname = dir_name + '/host.txt'
export_path = dir_name + '/output.reg'

template = '''[HKEY_CURRENT_USER\Software\SimonTatham\PuTTY\Sessions\{}]
...
"PublicKeyFile"="C:\\\\Users\\\\ekendall\\\\Desktop\\\\sys_ops.ppk"
"RemoteCommand"=""
...
for x in file1:
    output = output + template.format(x[0],x[1]) + '\n' + '\n'
